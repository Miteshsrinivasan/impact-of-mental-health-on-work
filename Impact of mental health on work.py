...
labels = ["Gender:", "Job Role:", "Years of Experience:", "Hours Worked per Week:", 
          "Number of Virtual Meetings:", "Social Isolation Rating:", 
          "Company Support for Remote Work:", "Physical Activity:", 
          "Sleep Quality:", "Region:"]
...
# Assign entries to variable names for easy access
(gender_entry, job_role_entry, years_of_experience_entry, hours_worked_per_week_entry,
 number_of_virtual_meetings_entry, social_isolation_rating_entry, 
 company_support_for_remote_work_entry, physical_activity_entry, 
 sleep_quality_entry, region_entry) = entries
